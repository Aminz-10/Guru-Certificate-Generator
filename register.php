...
<div class="auth-card">
    ...
    <div style="text-align:center; margin-bottom: 2rem;">
        <h2 style="margin:0; font-size:1.75rem; font-weight:800; color:#0f172a; letter-spacing:-0.025em;">Get Started ✨</h2>
        <p style="color:#64748b; font-size:0.95rem; margin-top:0.5rem;">Join us and start generating!</p>
    </div>
    ...
    <form id="registerForm">
        <div style="margin-bottom: 1rem;">
            ...
            <input type="text" name="name" class="form-control" placeholder="Cikgu Amin" required autofocus>
        </div>

        <div style="margin-bottom: 1rem;">
            <label class="form-label">Email Address</label>
            <input type="email" name="email" class="form-control" placeholder="hello@certigen.com" required>
        </div>
        
        <div style="margin-bottom: 1.5rem;">
            <label class="form-label">Password</label>
            <div class="password-toggle-wrapper">
                <input type="password" name="password" id="passwordInput" class="form-control" placeholder="••••••••" required minlength="6" style="padding-right: 3.5rem;">
                <button type="button" onclick="togglePasswordVisibility('passwordInput', 'toggleIcon')" class="password-toggle-btn" tabindex="-1">
                    <span id="toggleIcon">👁️</span>
                </button>
            </div>
            <small style="display:block; margin-top:0.4rem; color:#94a3b8; font-size:0.7rem;">At least 6 characters required</small>
        </div>
        
        <button type="submit" id="registerBtn" class="btn-auth" style="margin-top:0.5rem;">Create Account</button>
    </form>
...
document.getElementById('registerForm').onsubmit = async (e) => {
    ...
    try {
        ...
        if (result.success) {
            showStatus('Account Created! ✨', result.message, '✨', true);
            setTimeout(() => {
